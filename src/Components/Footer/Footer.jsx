                    ...
                    <div className="grid grid-cols-4">
                        ...
                        <div>
                            ...
                            <div className="footer_social flex items-center gap-3">
                                ...
                                <Facebook size='1.5rem' color="#007580"  /></Link>


                                <Link className="p-3 inline-block"><Twitter size='1.5rem' color="#007580" /></Link>


                                <Link className="p-3 inline-block"><Instagram size='1.5rem' color="#007580" />
                                <a href="https://www.instagram.com/"></a> </Link>
            ...
            <div className="footer_bottom w-full h-[75px] flex items-center justify-center ">
                <div className="lg:container mx-auto">
                    <div className="flex items-center justify-between">
                        <div>
                           <p className="text-base text-[#9a9caa] font-normal font-inter">@ 2025 Blogy- Designed & Develop <span className="text-[#272343]">Pradeep Singh Thakur</span></p> 
                        </div>
